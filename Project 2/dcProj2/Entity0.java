...
{    
    ...
    public Entity0()
    {
     ...
     packet = new Packet(0,1,mincost);
     NetworkSimulator.toLayer2(packet);

     packet = new Packet(0,2,mincost);
     NetworkSimulator.toLayer2(packet);

     packet = new Packet(0,3,mincost);
     NetworkSimulator.toLayer2(packet);

     // Print the initial distance vector table
     System.out.println("Initial Distance Vector Table of NODE O (Zer0) \n");
     printDT();
    }
